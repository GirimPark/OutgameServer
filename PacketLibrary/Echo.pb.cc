...
const uint32_t TableStruct_Echo_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Protocol::S2C_Echo, message_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::C2S_Echo, message_),
};
...
const char descriptor_table_protodef_Echo_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\nEcho.proto\022\010Protocol\"\033\n\010S2C_Echo\022\017\n\007me"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Echo_2eproto = {
  false, false, 88, descriptor_table_protodef_Echo_2eproto, "Echo.proto", 
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "Protocol.S2C_Echo.message"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          auto str = _internal_mutable_message();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "Protocol.C2S_Echo.message"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
